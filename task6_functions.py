...
# a) Function to calculate total sales from NA, EU, and JP
...
# b) Function to filter games by genre with default value of 'Platform'
...
# c) Function that returns a formatted summary string
